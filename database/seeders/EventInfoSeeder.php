...
class EventInfoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        EventInfo::create([
            'date' => '1936-04-19',
            'event_year' => date('Y', strtotime('1936-04-19')), 
        ...
        EventInfo::create([
            'date' => '1937-07-07',
            'event_year' => date('Y', strtotime('1937-07-07')), 
        ...
        EventInfo::create([
            'date' => '1939-05-17',
            'event_year' => date('Y', strtotime('1939-05-17')), 
        ...
        EventInfo::create([
            'date' => '1947-11-29',
            'event_year' => date('Y', strtotime('1947-11-29')), 
        ...
        EventInfo::create([
            'date' => '1948-05-14',
            'event_year' => date('Y', strtotime('1948-05-14')), 
